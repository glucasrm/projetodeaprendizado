...
import { MessageCircle, Plus, Search, Bell } from 'lucide-react'; // Certifique-se de importar Bell
...
const Navbar = () => {
    ...
    // Pegue unreadNotificationsCount do UserContext
    const { user, login, unreadNotificationsCount } = useContext(UserContext); // <--- ADIÇÃO AQUI
                    ...
                    {login ? (
                        <div className="flex items-center space-x-2">
                            ...
                            <button
                                ...
                                className="text-white hover:text-yellow-400 transition relative" // Adicione 'relative' para posicionar o badge
                                title="Notificações"
                            >
                                <Bell size={22} />
                                {unreadNotificationsCount > 0 && ( // <--- ADIÇÃO DO BADGE
