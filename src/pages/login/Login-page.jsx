    ...
    <div className="flex justify-center h-screen bg-gray-950 text-white">
      ...
      >
        ...
        <img src={Logo} className="w-10 h-auto" alt="Trem Loco" />
          ...
          <h1 className=" flex justify-center font-bold text-5xl mb-1 mt-6">Login
          </h1>

          <p className="flex justify-center mt-5 flex row text-gray-500"> Não tem conta?
            <button className="hover:text-blue-500 text-blue-400" onClick={() =>navigate('/cadastro')}>Cadastre-se</button>
          </p>
